    ...
    <div className='h-[calc(100vh-120px)] border flex justify-center items-center'>
        ...
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {
                    message && <p className='text-red-500 text-xs itelic mb-3'>{message}</p>
                }
                <div>
            ...
            <p className='align-baseline font-medium mt-4 text-sm'>Don't have an account? please <Link to="/register" className='text-blue-500 hover:text-blue-700'>Register</Link>
            </p>
            {/* google sign in */}
            <div className='mt-3'>
                <button
